document.addEventListener("DOMContentLoaded", () => {
  ...
  symptomsForm.addEventListener("submit", async (e) => {
    ...
    try {
      const res = await fetch(`http://localhost:8080/api/sessions/${currentSessionId}/symptoms`, {
        method: "POST",
        headers: { "Content-Type": "application/json" },
  ...
  recordBtn.addEventListener("click", async () => {
    ...
    try {
      const res = await fetch(`http://localhost:8080/api/sessions/${currentSessionId}/signals`, {
        method: "POST",
        headers: { "Content-Type": "application/json" },
